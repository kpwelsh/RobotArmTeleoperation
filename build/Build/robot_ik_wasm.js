...
export function test(v) {
    try {
        var ret = wasm.test(addBorrowedObject(v));
...
* @param {boolean} self_collision
*/
export function set_self_collision(iksolver, self_collision) {
    wasm.set_self_collision(iksolver, self_collision);
}
...
* @returns {number}
*/
export function dof(iksolver) {
    var ret = wasm.dof(iksolver);
    return ret;
}
...
*/
export function solve(iksolver, current_q, trans) {
    try {
        var ret = wasm.solve(iksolver, addBorrowedObject(current_q), addBorrowedObject(trans));
        return takeObject(ret);
    } finally {
        heap[stack_pointer++] = undefined;
        heap[stack_pointer++] = undefined;
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('robot_ik_wasm_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
